...
const portfolios = [
  {
    ...
    category: "Web Design",
    title: "EnjoySpots",
    description: " enjoySpots website for Entertainment ",
    technologies: [
      "NextJs",
      "Tailwind css",
      "MongoDB",
  ...
  },
  {
    ...
    category: "Web Design",
    title: "Tasty Treat",
    description: "delivery website for pizza and Burger ",
    technologies: [
      "reactjs",
      "NodeJs",
      "firebase",
  ...
  },
  {
    ...
    category: "Web Design",
    title: "Medical Care",
    description: " e-Commerce website for booking Appointment for Doctors   ",
    technologies: [
      "Reactjs",
      "Tailwind css",
      "MongoDB",
  ...
  },
  {
    ...
    category: "Web Design",
    title: "TODO App",
    description: " todo app for mange your tasks ",
  ...
  },
  {
    ...
    siteUrl: "https://dev-e-c0mm.pantheonsite.io/",
  },
  // {
  //   id: "15",
  //   imgUrl: portfolioImg15,
  //   category: "Web Design",
  //   title: "Dashboard",
  //   description: "Dashbourd for contacting customers and controlers",
...

  {
    ...
    category: "Web Design",
    title: "Tech PlatForm",
    description: " e-Commerce website for booking udemy courses   ",
    technologies: [
      "NextJS",
      "ReactJS",
      "Tailwind css",
...

  {
    ...
    description: "e-commerce website for booking appartment",
    technologies: [
      "NextJs",
      "tailwindCss",
      "NodeJs",
  ...
  //   siteUrl:
  //     "https://6583f9ff215c8cc5986c9fcc--jolly-pothos-a34d6a.netlify.app/",
  // },
  ...
  //   category: "Web design",
  //   title: "HD movies",
  //   description: "HD movies website for whatching movies ",
  //   technologies: ["React", "Tailwind css", "firebase"],
  ...
  //   description: "amazon dashbourd for admin to do crud operation",
  ...
  //   category: "Mobile App",
  //   title: "Amazon app",
  //   description: "Amazon app for shoping products  (e-commerce)",
  ...
  //   description: "kms e-commerce for shoping using ",
